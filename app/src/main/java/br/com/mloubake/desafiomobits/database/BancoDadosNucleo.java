...
public class BancoDadosNucleo extends SQLiteOpenHelper {
    ...
    //Usuário
    protected static final String KEY_USUARIO_ID = "_usuarioId";
    protected static final String KEY_USUARIO_CONTA_CORRENTE = "usuarioContaCorrente";
    protected static final String KEY_USUARIO_CONTA_SENHA = "usuarioContaSenha";
    protected static final String KEY_USUARIO_TIPO_CLIENTE = "usuarioTipoCliente";
    //Conta
    ...
    protected static final String KEY_SALDO = "saldo";
    //Movimentação
    protected static final String KEY_MOVIMENTACAO_ID = "_movimentacaoId";
    protected static final String KEY_DATA = "data";
    protected static final String KEY_HORARIO = "horario";
    protected static final String KEY_TIPO_MOVIMENTACAO = "tipoMovimentacao";
    protected static final String KEY_CONTA_ORIGEM = "contaOrigem";
    protected static final String KEY_CONTA_DESTINO = "contaDestino";
    protected static final String KEY_VALOR = "valor";

    public BancoDadosNucleo(Context context) {
...
//                "senha text not null);");
        ...
        String sqlUsuario = "CREATE TABLE " + TABELA_USUARIO + " ("
                ...
                + KEY_USUARIO_CONTA_CORRENTE + " integer,"
                + KEY_USUARIO_CONTA_SENHA + " integer,"
                + KEY_USUARIO_TIPO_CLIENTE + " integer"
                + ")";
        ...
        String sqlMovimentacao = "CREATE TABLE " + TABELA_MOVIMENTACAO + " ("
                + KEY_MOVIMENTACAO_ID + " integer primary key autoincrement,"
                + KEY_DATA + " string,"
                + KEY_HORARIO + " string,"
                + KEY_CONTA_ORIGEM + " integer,"
                + KEY_CONTA_DESTINO + " integer,"
        ...
        Log.d("", "versãoAtual: " + bd.getVersion());
    }
